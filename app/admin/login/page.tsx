    ...
    <div className="min-h-screen bg-[#EFE9DB] flex items-center justify-center p-4 font-sans">
      ...
      >
        ...
        <div className="md:w-1/2 bg-retro-red p-12 flex flex-col items-center justify-center border-b-[4px] md:border-b-0 md:border-r-[4px] border-retro-charcoal">
          ...
          <svg width="240" height="180" viewBox="0 0 240 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-xl transition-transform hover:scale-105 duration-300">
            <rect x="20" y="60" width="200" height="100" rx="10" fill="#333333" stroke="#262626" strokeWidth="4"/>
            <rect x="24" y="100" width="192" height="56" fill="#262626"/>
            <path d="M20 70C20 64.4772 24.4772 60 30 60H210C215.523 60 220 64.4772 220 70V100H20V70Z" fill="#F0EBE1" stroke="#262626" strokeWidth="4"/>
            <rect x="35" y="45" width="25" height="15" rx="4" fill="#F0EBE1" stroke="#262626" strokeWidth="4"/>
            <circle cx="180" cy="80" r="12" fill="#1A1A1A" stroke="#262626" strokeWidth="4"/>
            <rect x="170" y="75" width="20" height="10" fill="#333333"/>
            <circle cx="85" cy="80" r="10" fill="#d9383a" stroke="#262626" strokeWidth="3"/>
            <circle cx="120" cy="115" r="45" fill="#E5E0D8" stroke="#262626" strokeWidth="4"/>
            <circle cx="120" cy="115" r="35" fill="#333333" stroke="#262626" strokeWidth="4"/>
            <circle cx="120" cy="115" r="22" fill="#1A1A1A"/>
            <circle cx="128" cy="107" r="6" fill="#4D4D4D"/>
            <rect x="40" y="110" width="10" height="30" rx="5" fill="#E5E0D8" stroke="#262626" strokeWidth="3"/>
            <rect x="190" y="110" width="10" height="20" rx="5" fill="#E5E0D8" stroke="#262626" strokeWidth="3"/>
          </svg>
        </div>
