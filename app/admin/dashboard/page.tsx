...
import { DollarSign, Ticket, ArrowUpRight, Activity } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      ...
      try {
        // Mengambil data dari endpoint Vouchers yang sudah kita buat
        ...
        let activeCount = 0;
        if (res.ok) {
          const voucherList = data.data || data;
          if (Array.isArray(voucherList)) {
            // Menghitung hanya kupon yang statusnya is_active = true
